...
//       >
//         <Image src={assets.profile_img} alt="" className="rounded-lg w-50" />
//       </motion.div>
//       <motion.h3
...
//           href="#contact"
//           className="flex items-center    gap-2 px-10 py-3 border border-white bg-black text-white rounded-full "
//         >
//           {" "}
//           contact me
//           <Image
...
//           download
//           className={`flex items-center gap-2 font-ovo px-10 py-3 border rounded-full transition-colors duration-300 
//     ${
//       isDarkMode
